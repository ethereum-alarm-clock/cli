...
program
  ...
  .option('--maxGasSubsidy <eth>', 'Subsidize a percentage of gas costs on gas spikes')
  .option('--usingSmartGasEstimation', 'Subsidize a percentage of gas costs on gas spikes')
