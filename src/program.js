...
program
  ...
  .option('--maxDeposit <eth>', 'Only claim transactions that require a deposit lower than', Config.DEFAULT_ECONOMIC_STRATEGY.maxDeposit / Math.pow(10, 18))
  .option('--minBalance <eth>', 'Only claim transactions if balance of wallet is higher', Config.DEFAULT_ECONOMIC_STRATEGY.minBalance / Math.pow(10, 18))
  .option('--minProfitability <eth>', 'Only claim transactions with a bounty higher', Config.DEFAULT_ECONOMIC_STRATEGY.minProfitability / Math.pow(10, 18))
