...
program
  ...
  .option('--maxDeposit <eth>', 'Only claim transactions that require a deposit lower than', Config.DEFAULT_ECONOMIC_STRATEGY.maxDeposit)
  .option('--minBalance <eth>', 'Only claim transactions if balance of wallet is higher', Config.DEFAULT_ECONOMIC_STRATEGY.minBalance)
  .option('--minProfitability <eth>', 'Only claim transactions with a bounty higher', Config.DEFAULT_ECONOMIC_STRATEGY.minProfitability)
